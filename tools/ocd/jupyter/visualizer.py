...
class JupyterVisualizer:
  @classmethod
  def interactive_slice_viewer(cls, data, axis=2, cmap="gray", title_prefix=""):
    """
    ...
    widgets.interactive_output(
      update, {"slice_idx": slice_slider, "win_min": window_min, "win_max": window_max}
    )
  ...
  @classmethod
  def interactive_ct_seg_viewer(cls, ct_data, seg_data, axis=2, title_prefix=""):
    """
